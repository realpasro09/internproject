(function (angular) {
	...
	angular.module('App').controller('OfficeDashboard', officeDashboard);

	function officeDashboard($scope, $uibModal, $state, DData) {
		...
		$scope.Search = function() {
			$state.go('Master.Page.Office.LawyerDashboard', {}, {reload:true});
		};
